...
public class ViewProfileServlet extends HttpServlet {
    ...
    if(command.equals("student"))   
    {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("ViewStudentPage.jsp");
        dispatcher.forward(request, response);
    }
    else if(command.equals("hod"))
    {
        request.setAttribute("branch", branch);
        RequestDispatcher dispatcher = request.getRequestDispatcher("ViewFacultyPage.jsp");
        dispatcher.forward(request, response);
    }
