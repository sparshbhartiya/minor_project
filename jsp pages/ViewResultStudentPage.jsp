...
<%@page import="java.util.ArrayList, Pojo.ViewResultPojo, static DaoClass.ViewResultDao.ViewResultStudent, static DaoClass.ViewResultDao.Voting"%>
...
tr:nth-child(even) {
  background-color: #dddddd;
    ...
    if(username==null)
    {
        ...
        ArrayList<ViewResultPojo> t = ViewResultStudent(branch);
        
        int Voting[]= new int[3];
        Voting = Voting(branch,"student");
     %>
       
    <body>
        <h1 style="text-align: center"> Student Vote Count</h1>
  <br> <br>
