<%@page import="ViewStudents.ViewStudentProfilePojo"%>
...
<body>
    <% 
    	ViewStudentProfilePojo student = (ViewStudentProfilePojo) request.getAttribute("Student_Profile");
 	%>
...
<div class="card">
  ...
  <span class="tags"><%= student.getEnrollNo() %></span>
  <span class="tags">DOB:<%= student.getDob() %></span>
  <span class="tags"><%= student.getYear() %> Year</span>
  <br>
