<%-- 
    ...
    Created on : Mar 11, 2019, 12:09:52 AM
    Author     : saura
--%>
<%@ page import="static DaoClass.TeacherRegisterDao.GetNewId" %>
...
<div class="container">
  <form name="frm" action="TeacherRegistrationServlet" method="post">
  <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    ...
    <div class="col-75">
        <input type="text" id="id" name="facultyid"  value="<%= Id %>" required placeholder="Faculty ID">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
