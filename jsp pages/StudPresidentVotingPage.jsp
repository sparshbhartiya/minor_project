<%-- 
    Document   : StudPresidentVotingPage
    Created on : Mar 9, 2019, 2:42:54 PM
    Author     : saura
--%>
...
tr:nth-child(even) {
 ...
 <%
   ...
   ArrayList<VotingCandDetailPojo> CandDetail = CandidateDetail(VoterDetail[3],"student");
   %>
<body>
<div>
 ...
 Voter Type- <%= VoterDetail[2] %>
  ...
  <h1 style="text-align: center"> Student Voting Page</h1>
  <br><br><br>
 <div>
   <table>
  <tr>
 ...
 <tr>
     ...
     <td>
        <form action="VoteCountServlet" method="post">
            ...
            <input type="hidden" name="candtype" value="student">
